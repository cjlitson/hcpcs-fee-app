...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self._light_theme_qss = (
            ...
            "QPushButton[deleteAction='true'] { background: #FFFFFF; color: #B42318; border: 1px solid #F2C7C4; padding: 0; border-radius: 6px; }"
            "QPushButton[deleteAction='true']:hover { background: #FFF1F0; border-color: #E6938E; }"
        ...
        self._dark_theme_qss = (
            ...
            "QPushButton[deleteAction='true'] { background: #232830; color: #FF938B; border: 1px solid #7B3A35; padding: 0; border-radius: 6px; }"
            "QPushButton[deleteAction='true']:hover { background: #3A2525; border-color: #A55650; }"
