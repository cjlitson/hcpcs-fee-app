...
def test_launch_updater_workflow_passes_asset_context_and_exits(tmp_path, monkeypatch):
    ...
    asset_url = "https://github.com/cjlitson/hcpcs-fee-app/releases/download/v1.0.0/HCPCSFeeApp.exe"
    release_url = "https://github.com/cjlitson/hcpcs-fee-app/releases/tag/v1.0.0"
